...
Retrieve Datatables
    ...
    @{row_1_2} =    Create List    pipi       0.40
    @{row_1_3} =    Create List    caca       0.50
    @{datatable_1} =    Create List    ${row_1_1}    ${row_1_2}    ${row_1_3}

    @{row_2_1} =    Create List    product    price
    @{row_2_2} =    Create List    rouge      0.40
    @{row_2_3} =    Create List    vert       0.60
