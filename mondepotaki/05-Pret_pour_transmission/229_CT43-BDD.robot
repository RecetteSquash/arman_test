...
Test Setup
    ...
    END
    IF    $TEST_229_SETUP_VALUE is not None
        Run Keyword    ${TEST_229_SETUP}
    END
...
Test Teardown
    ...
    IF    $TEST_229_TEARDOWN_VALUE is not None
        Run Keyword    ${TEST_229_TEARDOWN}
    END
