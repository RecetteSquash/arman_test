...
Test Setup
    ...
    END
    IF    $TEST_242_SETUP_VALUE is not None
        Run Keyword    ${TEST_242_SETUP}
    END
...
Test Teardown
    ...
    IF    $TEST_242_TEARDOWN_VALUE is not None
        Run Keyword    ${TEST_242_TEARDOWN}
    END
